...
- Nota historica posterior al Sprint 08: la brecha de disponibilidad de anulacion de ventas y carritos pendientes quedo resuelta por el correctivo backend. La regresion automatizada posterior confirmo motivo obligatorio, permisos, caja cerrada, reversa de pago, movimientos inversos, expiracion, revalidacion y conversion dentro del alcance V1.

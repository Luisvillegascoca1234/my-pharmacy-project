...
El desarrollo documentado no incluye todavía controllers, routes, services, repositories, endpoints HTTP, OpenAPI completo, stores Zustand ni pantallas para proveedores o compras. Tampoco ejecuta aún las reglas de recepción, anulación, creación de capas o creación de movimientos. El resultado del sprint debe interpretarse como fundamento arquitectónico y persistente para esas capacidades, no como cierre funcional del epic.

...
import type { CreateProduct, Product, ProductType, UpdateProductUnits } from "@pharmacy-pos/shared";
...
import { productStatusLabels, productTypeLabels } from "../constants/product-labels";
